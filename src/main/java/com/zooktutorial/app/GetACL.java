...
public class GetACL {
    public static void main(String... args) throws InterruptedException, IOException, KeeperException {
        ...
        /*
         * from Zookeeper command prompt [zk: localhost:2181(CONNECTED) 17] getAcl /SampleNode 'world,'anyone : cdrwa
         * You can update default access by below command [zk: localhost:2181(CONNECTED) 27] setAcl /SampleNode
         * world:anyone:card
         */
        for (ACL aclItem : acl) {
